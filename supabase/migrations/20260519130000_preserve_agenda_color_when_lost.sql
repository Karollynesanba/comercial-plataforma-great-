-- Preserve the agenda color when a CRM lead moves to PERDIDO.
-- Only NO_SHOW should force a red agenda color.
...
BEGIN
  ...
  SELECT ae.id, ae.title, ae.title_locked, ae.color
    INTO agenda_event_id, existing_title, existing_title_locked, existing_color
