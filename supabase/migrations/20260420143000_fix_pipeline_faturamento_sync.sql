-- Keep CRM as the source of truth while making sure pipeline faturamento values
-- can always be mirrored into agendamento_leads without breaking the trigger.
