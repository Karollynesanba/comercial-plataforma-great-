    ...
    <div className="space-y-6 animate-in">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-2 max-w-3xl">
              Análise individual dos SDRs oficiais: Herbert, Alan, Raul, Cleriston, Xavier e João Vitor. Os outros usuários podem agendar no pipeline, mas não entram como SDR oficial nesta leitura.
            </p>
          </div>
        ...
        <CardHeader>
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
              ...
              <CardDescription>
                Grade separada por semana e dia: Herbert, Alan, Raul, Cleriston, Xavier, João Vitor e Total calculado automaticamente. Edite as células do SDR e salve ao sair do campo ou em lote.
              </CardDescription>
            </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Todos que podem marcar reuniÃ£o aparecem aqui. Herbert, Alan, Raul, Cleriston, Xavier e João Vitor continuam destacados como SDRs oficiais, mas Pedro, Cled e Bruno tambÃ©m tÃªm leitura de agendamentos e vendas geradas pelos leads que agendaram.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
